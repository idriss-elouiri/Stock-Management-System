...
const response = await fetch(`${API_URL}/api/products?limit=1000`);
  ...
  const handleSubmitSuccess = () => {
    ...
    fetchProducts();
    toast.success(selectedProduct ? 'Produit mis à jour' : 'Nouveau produit ajouté');
  };
  ...
  const filteredProducts = products.filter(product => {
    ...
    const matchesLowStock = filterLowStock ? product.quantity <= product.minStockLevel : true;
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">Gérez votre inventaire de produits facilement et professionnellement</p>
        </div>
